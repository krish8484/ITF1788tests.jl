...
@testset "minimal_is_member_test" begin
    ...
    @test ∈(0x1.fffffffffffffp1023, entireinterval(Float64))
    @test in(0x1.fffffffffffffp1023, entireinterval(Float64))
    @test ∈(-0x1.fffffffffffffp1023, entireinterval(Float64))
    @test in(-0x1.fffffffffffffp1023, entireinterval(Float64))
    @test ∈(0x1.0p-1022, entireinterval(Float64))
    @test in(0x1.0p-1022, entireinterval(Float64))
    @test ∈(-0x1.0p-1022, entireinterval(Float64))
    @test in(-0x1.0p-1022, entireinterval(Float64))
    ...
    @test ∈(Inf, entireinterval(Float64)) == false
    @test in(Inf, entireinterval(Float64)) == false
    @test ∈(NaN, entireinterval(Float64)) == false
    @test in(NaN, entireinterval(Float64)) == false
end
...
@testset "minimal_is_member_dec_test" begin
    ...
    @test ∈(0x1.fffffffffffffp1023, DecoratedInterval(entireinterval(Float64), def))
    @test in(0x1.fffffffffffffp1023, DecoratedInterval(entireinterval(Float64), def))
    @test ∈(-0x1.fffffffffffffp1023, DecoratedInterval(entireinterval(Float64), dac))
    @test in(-0x1.fffffffffffffp1023, DecoratedInterval(entireinterval(Float64), dac))
    @test ∈(0x1.0p-1022, DecoratedInterval(entireinterval(Float64), trv))
    @test in(0x1.0p-1022, DecoratedInterval(entireinterval(Float64), trv))
    @test ∈(-0x1.0p-1022, DecoratedInterval(entireinterval(Float64), def))
    @test in(-0x1.0p-1022, DecoratedInterval(entireinterval(Float64), def))
    ...
    @test ∈(Inf, nai()) == false
    @test in(Inf, nai()) == false
    @test ∈(NaN, DecoratedInterval(∅, trv)) == false
    @test in(NaN, DecoratedInterval(∅, trv)) == false
    @test ∈(NaN, nai()) == false
    ...
    @test ∈(NaN, DecoratedInterval(entireinterval(Float64), dac)) == false
    @test in(NaN, DecoratedInterval(entireinterval(Float64), dac)) == false
end
