...
@testset "minimal_pos_dec_test" begin
    ...
    @test +DecoratedInterval(entireinterval(Float64), dac) == DecoratedInterval(entireinterval(Float64), dac)
...
@testset "minimal_recip_dec_test" begin
    ...
    @test inv(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(entireinterval(Float64), trv)
    @test (DecoratedInterval(entireinterval(Float64), dac))^(-1) == DecoratedInterval(entireinterval(Float64), trv)
    @test (DecoratedInterval(entireinterval(Float64), dac))^(-1//1) == DecoratedInterval(entireinterval(Float64), trv)
    @test (DecoratedInterval(entireinterval(Float64), dac))^(-1.0) == DecoratedInterval(entireinterval(Float64), trv)
    @test 1 /(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(entireinterval(Float64), trv)
end
...
@testset "minimal_sin_dec_test" begin
    ...
    @test sin(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-1.0, 1.0), dac)
end
...
@testset "minimal_cos_dec_test" begin
    ...
    @test cos(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-1.0, 1.0), dac)
end
...
@testset "minimal_tan_dec_test" begin
    ...
    @test tan(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(entireinterval(Float64), trv)
...
@testset "minimal_asin_dec_test" begin
    ...
    @test asin(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
...
@testset "minimal_acos_dec_test" begin
    ...
    @test acos(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
...
@testset "minimal_atan_dec_test" begin
    ...
    @test atan(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac)
...
@testset "minimal_atan2_dec_test" begin
    @test atan2(DecoratedInterval(∅, trv), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test atan2(DecoratedInterval(∅, trv), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(∅, trv)
    ...
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(0.0, 0.0), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(0.0, -0.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-0.0, 0.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-0.0, -0.0), trv)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-2.0, -0.1), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-2.0, 0.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-2.0, -0.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-2.0, 1.0), trv)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(0.0, 1.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(-0.0, 1.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test atan2(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(0.1, 1.0), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac)
    @test atan2(DecoratedInterval(Interval(0.0, 0.0), com), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test atan2(DecoratedInterval(Interval(0.0, 0.0), dac), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    ...
    @test atan2(DecoratedInterval(Interval(-0.0, -0.0), com), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test atan2(DecoratedInterval(Interval(-0.0, -0.0), def), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @test atan2(DecoratedInterval(Interval(-0.0, -0.0), dac), DecoratedInterval(Interval(0.0, 0.0), com)) == DecoratedInterval(∅, trv)
    ...
    @test atan2(DecoratedInterval(Interval(-2.0, -0.1), def), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0.0), def)
    ...
    @test atan2(DecoratedInterval(Interval(-2.0, 0.0), def), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    ...
    @test atan2(DecoratedInterval(Interval(-2.0, 1.0), dac), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    ...
    @test atan2(DecoratedInterval(Interval(0.0, 1.0), dac), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    ...
    @test atan2(DecoratedInterval(Interval(0.1, 1.0), dac), DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), dac)
...
@testset "minimal_sinh_dec_test" begin
    @test sinh(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(entireinterval(Float64), dac)
...
@testset "minimal_tanh_dec_test" begin
    ...
    @test tanh(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(-1.0, 1.0), dac)
...
@testset "minimal_asinh_dec_test" begin
    ...
    @test asinh(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(entireinterval(Float64), dac)
...
@testset "minimal_acosh_dec_test" begin
    ...
    @test acosh(DecoratedInterval(entireinterval(Float64), dac)) == DecoratedInterval(Interval(0.0, Inf), trv)
...
@testset "minimal_floor_dec_test" begin
    ...
    @test round(DecoratedInterval(Interval(-0x1.fffffffffffffp1023, -0x1.fffffffffffffp1023), com), RoundDown) == DecoratedInterval(Interval(-0x1.fffffffffffffp1023, -0x1.fffffffffffffp1023), dac)
end
...
@testset "minimal_trunc_dec_test" begin
    ...
    @test round(DecoratedInterval(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), com), RoundToZero) == DecoratedInterval(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), dac)
    ...
    @test round(DecoratedInterval(Interval(0x1.fffffffffffffp1023, Inf), dac), RoundToZero) == DecoratedInterval(Interval(0x1.fffffffffffffp1023, Inf), def)
end
...
@testset "minimal_min_dec_test" begin
    @test min(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(1.0, 2.0), com)) == DecoratedInterval(Interval(-Inf, 2.0), dac)
...
@testset "minimal_max_dec_test" begin
    @test max(DecoratedInterval(entireinterval(Float64), dac), DecoratedInterval(Interval(1.0, 2.0), com)) == DecoratedInterval(Interval(1.0, Inf), dac)
