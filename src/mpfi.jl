...
@testset "mpfi_atan2" begin
    # special values
    @test atan2(Interval(-Inf, -7.0), Interval(-1.0, +8.0)) == Interval(-0x6d9cc4b34bd0dp-50, -0x1700a7c5784633p-53)
    @test atan2(Interval(-Inf, 0.0), Interval(+8.0, Inf)) == Interval(-0x1921fb54442d19p-52, 0.0)
    @test atan2(Interval(-Inf, +8.0), Interval(0.0, +8.0)) == Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
    @test atan2(entireinterval(Float64), Interval(0.0, +8.0)) == Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
    @test atan2(Interval(0.0, 0.0), Interval(-Inf, -7.0)) == Interval(0x1921fb54442d18p-51, 0x1921fb54442d19p-51)
    @test atan2(Interval(0.0, +8.0), Interval(-7.0, 0.0)) == Interval(0x3243f6a8885a3p-49, 0x1921fb54442d19p-51)
    @test atan2(Interval(0.0, 0.0), Interval(0.0, +8.0)) == Interval(0.0, 0.0)
    @test atan2(Interval(0.0, Inf), Interval(0.0, +8.0)) == Interval(0.0, 0x1921fb54442d19p-52)
    @test atan2(Interval(0.0, 0.0), Interval(+8.0, Inf)) == Interval(0.0, 0.0)
    @test atan2(Interval(0.0, 0.0), entireinterval(Float64)) == Interval(0.0, 0x1921fb54442d19p-51)
    @test atan2(Interval(0.0, +8.0), Interval(-7.0, +8.0)) == Interval(0.0, 0x1921fb54442d19p-51)
    @test atan2(Interval(0.0, 0.0), Interval(0.0, 0.0)) == ∅
    @test atan2(Interval(0.0, Inf), Interval(0.0, +8.0)) == Interval(0.0, 0x1921fb54442d19p-52)
    # regular values
    @test atan2(Interval(-17.0, -5.0), Interval(-4002.0, -1.0)) == Interval(-0x191f6c4c09a81bp-51, -0x1a12a5465464cfp-52)
    @test atan2(Interval(-17.0, -5.0), Interval(1.0, 4002.0)) == Interval(-0x1831516233f561p-52, -0xa3c20ea13f5e5p-61)
    @test atan2(Interval(5.0, 17.0), Interval(1.0, 4002.0)) == Interval(0xa3c20ea13f5e5p-61, 0x1831516233f561p-52)
    @test atan2(Interval(5.0, 17.0), Interval(-4002.0, -1.0)) == Interval(0x1a12a5465464cfp-52, 0x191f6c4c09a81bp-51)
    @test atan2(Interval(-17.0, 5.0), Interval(-4002.0, 1.0)) == Interval(-0x1921fb54442d19p-51, 0x1921fb54442d19p-51)
end
